 ...
 *
 */
public class InductionMotor3PhaseAdapterImpl extends DynLoadModel3Phase implements
		InductionMotor3PhaseAdapter {
	...
	public InductionMotor3PhaseAdapterImpl(){
		
	}
	
    public InductionMotor3PhaseAdapterImpl(InductionMotor motor){
		this.indMotor = motor;
	}
